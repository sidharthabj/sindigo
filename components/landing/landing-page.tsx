...
import { FadeUp, InView, ScrollIndicator } from './motion-wrappers'
  ...
  return (
    <div className="overflow-x-hidden bg-background text-foreground">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 pb-24 pt-16 text-center">
        ...
        <FadeUp delay={0.22} className="mt-7">
          <p className="max-w-[38ch] text-[1.0625rem] leading-relaxed text-muted-foreground">
      ...
      <section className="px-6 py-32 text-center">
        <InView className="mx-auto max-w-md space-y-9">
